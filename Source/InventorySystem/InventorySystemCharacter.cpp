...
AInventorySystemCharacter::AInventorySystemCharacter()
{
	...
	InterativeComponent = CreateDefaultSubobject<UInterativeComponent>(TEXT("InterativeComponent"));
...
void AInventorySystemCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("BeginInterative", IE_Pressed, this, &AInventorySystemCharacter::BeginInterative);
	PlayerInputComponent->BindAction("EndInterative", IE_Pressed, this, &AInventorySystemCharacter::EndInterative);
}
...
void AInventorySystemCharacter::BeginInterative()
{
	InterativeComponent->BeginTrigger();
	
}

void AInventorySystemCharacter::EndInterative()
{
